...
export default function UpdateListing() {
    ...
    return (
      <div className="flex min-h-[60vh] items-center justify-center">
        <div className="text-center">
          <p className="text-[15px] font-light text-[#64748d]">No property data provided.</p>
          <button
  ...
  const form = useForm<z.infer<typeof formSchema>>({
    ...
    defaultValues: {
      ...
      yearBuild: property.yearBuild?.toString() ?? "",
  ...
  async function onSubmit(values: z.infer<typeof formSchema>) {
    ...
    try {
      const res = await fetch(`${import.meta.env.VITE_BACKEND_URL}/api/property/${property._id}`, {
        method: "PUT",
        headers: {
        ...
        <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6">
          ...
          <div className="flex justify-end pt-2">
            <Button
              ...
              className="rounded-full bg-[#533afd] px-6 py-2 text-[16px] font-normal text-white transition-all duration-200 hover:bg-[#4434d4] focus:outline-none focus:ring-2 focus:ring-[#533afd] focus:ring-offset-2 disabled:opacity-50"
            >
